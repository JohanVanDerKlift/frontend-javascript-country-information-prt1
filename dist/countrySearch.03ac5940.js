...
})({"5BiZP":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "bc0a6b3103ac5940";
"use strict";
...
},{}],"j7Ql9":[function(require,module,exports) {
...
function getCurrencyString(currencies) {
    if (currencies.length === 1) return `and you can pay with ${currencies[0].name}'s`;
        ...
        for(let i = 1; i < currencies.length; i++)currenciesString += ` and ${currencies[i].name}'s`;
        return currenciesString;
    }
}
function getLanguagesString(languages) {
    let languageString = `. They speak ${languages[0].name}`;
    for(let i = 1; i < languages.length - 1; i++)if (i === 1) languageString += `, ${languages[i].name}`;
    if (languages.length > 1) languageString += ` and ${languages[languages.length - 1].name}`;
...
},{"./../utils.js":"60BxC","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["5BiZP","j7Ql9"], "j7Ql9", "parcelRequirecb08")

//# sourceMappingURL=countrySearch.03ac5940.js.map
